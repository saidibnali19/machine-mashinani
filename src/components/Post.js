    ...
    return (
        <>
            <article className="border-2 border-gray-950 grid sm:grid-cols-2">
                <Image className="w-full h-full object-cover" src={"/images/featured.webp"} width={1024} height={1024} alt="" />
                <div className="p-4 space-y-4">
                    <div className="flex gap-4 flex-wrap">
                        <Link className="p-[.5em_1.5em] bg-sky-950 text-gray-50 text-xs rounded-full hover:opacity-75 focus-visible:opacity-75" href={"/"} >AI</Link>
                        <Link className="p-[.5em_1.5em] bg-sky-950 text-gray-50 text-xs rounded-full hover:opacity-75 focus-visible:opacity-75" href={"/"} >Agriculture</Link>
                    </div>
                    <h3 className="text-2xl text-sky-950">AI-Powered Agriculture: Transforming Kenya&apos;s Farming Landscape</h3>
                    <p>This blog post explores how artificial intelligence is revolutionizing agriculture in Kenya, from precision farming to crop disease detection, and its impact on smallholder farmers.</p>
                    <Link className="p-[.5em_1.5em] bg-sky-950 text-gray-50 hover:opacity-75 focus-visible:opacity-75 inline-block" href={"/"} >Read more</Link>
